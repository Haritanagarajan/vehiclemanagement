                    ...
                    <div className="col-6">
                        ...
                        <form className="form-horizontal">
                            <div className="form-group registerform">
                                <label className="control-label col-sm-2" for="fuelName">fuelName:</label>
                                <div className="col-sm-10">
                                    <input type="text" className="form-control" id="fuelName" placeholder="Enter fuelName" name="brandName" value={fuelName} onChange={(e) => setfuelName(e.target.value)} required />
                                </div>
