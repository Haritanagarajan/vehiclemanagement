                ...
                <div className='row justify-content-center'>
                    <div className="col-6">
                        ...
                        <form className="form-horizontal">
                            ...
                            <div className="form-group registerform" >
                                <label className="control-label col-sm-2" for="imageFile">File Upload:</label>
                                <div className="col-sm-10">
                                    <input type="file" className="form-control" id="imageFile" accept="image/*" placeholder="Upload yor brand image " name="imageFile" onChange={fileupload} />
                                </div>
