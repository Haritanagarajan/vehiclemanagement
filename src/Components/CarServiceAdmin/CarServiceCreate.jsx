                    ...
                    <div className="col-6">
                        ...
                        <form className="form-horizontal">
                            ...
                            <div className="form-group registerform">
                                ...
                                <div className="col-sm-10">
                                    <input type="number" className="form-control" id="timeTaken" placeholder="Enter timeTaken" name="timeTaken" value={timeTaken} onChange={(e) => settimeTaken(e.target.value)} required />
                                </div>
                                <span className="text-danger">{error}</span>
                            </div>
                            <div className="form-group registerform">
                                ...
                                <div className="col-sm-10">
                                    <input type="number" min="0" max="32767" className="form-control" id="servicecost" placeholder="Enter servicecost" name="servicecost" value={servicecost} onChange={(e) => setservicecost(e.target.value)} required />
                                </div>
                                <span className="text-danger">{error}</span>
                            </div>
